...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            <h3 class="box-title">Data Lazada</h3>

            <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Lazada Products</a>
        </div>
        ...
        <div class="box-body">
            <form action="{{url('lazadas/detail')}}" method="post">
                @csrf
                <div class="col-sm-1">
                    tambah product :
                </div>
                ...
                <div class="col-sm-2">
                    <label ></label>
                    <button type="submit" class="btn btn-default pull-left" data-dismiss="modal">Add</button>
                </div>
            </form>
        </div>
